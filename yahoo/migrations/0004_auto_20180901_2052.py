# Generated by Django 2.0.6 on 2018-09-01 12:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('insiders_hold_ratio', models.FloatField()),
        ...
        migrations.AddField(
            ...
            name='ref_earnings',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yahoo.EarningsCalendar'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='yahooprofilecompanyofficers',
            name='ref_earnings',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yahoo.EarningsCalendar'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='yahooholdersownership',
            name='ref_earnings',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yahoo.EarningsCalendar'),
        ),
        migrations.AddField(
            model_name='yahooholdersnetsharepurchaseactivity',
            name='ref_earnings',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yahoo.EarningsCalendar'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='yahoofinancialsincome',
            name='ref_earnings',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yahoo.EarningsCalendar'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='yahoofinancialsbalance',
            name='ref_earnings',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yahoo.EarningsCalendar'),
        ),
        migrations.AddField(
            model_name='yahooanalysisrevenueestimate',
            name='ref_earnings',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yahoo.EarningsCalendar'),
        ),
        migrations.AddField(
            model_name='yahooanalysisgrowthestimate',
            name='ref_earnings',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yahoo.EarningsCalendar'),
        ),
        migrations.AddField(
            model_name='yahooanalysisepstrend',
            name='ref_earnings',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yahoo.EarningsCalendar'),
        ),
        migrations.AddField(
            model_name='yahooanalysisepsrevisions',
            name='ref_earnings',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yahoo.EarningsCalendar'),
        ),
        migrations.AddField(
            model_name='yahooanalysisearningshistory',
            name='ref_earnings',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yahoo.EarningsCalendar'),
        ),
        migrations.AddField(
            model_name='yahooanalysisearningsestimate',
            name='ref_earnings',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yahoo.EarningsCalendar'),
        ),
    ]
