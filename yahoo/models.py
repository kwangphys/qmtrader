...
class DatedModel(dm.Model):
    ...
    updated_on = dm.DateTimeField(auto_now_add=False)
...
class YahooStatistics(DatedModel):
    ...
    market_cap_intraday = dm.FloatField(null=True)
    enterprise_value = dm.FloatField(null=True)
    trailing_pe_ratio = dm.FloatField(null=True)
    forward_pe_ratio = dm.FloatField(null=True)
    peg_ratio_5y_expected = dm.FloatField(null=True)
    price_sales_ratio = dm.FloatField(null=True)
    price_book_ratio = dm.FloatField(null=True)
    value_revenue_ratio = dm.FloatField(null=True)
    value_ebitda_ratio = dm.FloatField(null=True)
    beta = dm.FloatField(null=True)
    week52_change = dm.FloatField(null=True)
    week52_high = dm.FloatField(null=True)
    week52_low = dm.FloatField(null=True)
    day50_moving_average = dm.FloatField(null=True)
    day200_moving_average = dm.FloatField(null=True)
    fiscal_year_ends = dm.DateField(null=True)
    most_recent_quarter = dm.DateField(null=True)
    profit_margin = dm.FloatField(null=True)
    operating_margin = dm.FloatField(null=True)
    return_on_assets = dm.FloatField(null=True)
    return_on_equity = dm.FloatField(null=True)
    revenue = dm.FloatField(null=True)
    revenue_per_share = dm.FloatField(null=True)
    quarterly_revenue_growth = dm.FloatField(null=True)
    gross_profit = dm.FloatField(null=True)
    ebitda = dm.FloatField(null=True)
    net_income_avi_to_common = dm.FloatField(null=True)
    diluted_eps = dm.FloatField(null=True)
    quarterly_earnings_growth = dm.FloatField(null=True)
    total_cash = dm.FloatField(null=True)
    total_cash_per_share = dm.FloatField(null=True)
    total_debt = dm.FloatField(null=True)
    total_debt_to_equity = dm.FloatField(null=True)
    current_ratio = dm.FloatField(null=True)
    book_value_per_share = dm.FloatField(null=True)
    operating_cash_flow = dm.FloatField(null=True)
    levered_free_cash_flow = dm.FloatField(null=True)
    avg_vol_3m = dm.FloatField(null=True)
    avg_vol_10d = dm.FloatField(null=True)
    shares_outstanding = dm.FloatField(null=True)
    shares_float = dm.FloatField(null=True)
    insiders_hold_ratio = dm.FloatField(null=True)
    institutions_hold_ratio = dm.FloatField(null=True)
    shares_short = dm.FloatField(null=True)
    short_ratio = dm.FloatField(null=True)
    short_to_float_ratio = dm.FloatField(null=True)
    shares_short_prev_month = dm.FloatField(null=True)
...
class YahooFinancialsCashflow(DatedModel):
    ...
    total_cash_from_operating_activities = dm.FloatField(null=True)
    ...
    total_cashflows_from_investing_activities = dm.FloatField(null=True)
    dividends_paid = dm.FloatField(null=True)
    sale_purchase_of_stock = dm.FloatField(null=True)
    repurchase_of_stock = dm.FloatField(null=True)
    issuance_of_stock = dm.FloatField(null=True)
    net_borrowings = dm.FloatField(null=True)
    other_cashflows_from_financing_activities = dm.FloatField(null=True)
    total_cash_from_financing_activities = dm.FloatField(null=True)
    effect_of_exchange_rate = dm.FloatField(null=True)
    change_in_cash = dm.FloatField(null=True)
...
class YahooFinancialsBalance(DatedModel):
    ...
    total_current_assets = dm.FloatField(null=True)
    ...
    total_assets = dm.FloatField(null=True)
    ...
    total_current_liabilities = dm.FloatField(null=True)
    ...
    total_liab = dm.FloatField(null=True)
    ...
    net_tangible_assets = dm.FloatField(null=True)
...
class YahooFinancialsIncome(DatedModel):
    ...
    report_date = dm.DateField(null=False)
    report_freq = dm.CharField(max_length=9, choices=(('q', 'Quarterly'), ('a', 'Annual')))
    total_revenue = dm.FloatField(null=True)
    ...
    operating_income = dm.FloatField(null=True)
    ...
    minority_interest = dm.FloatField(null=True)
    net_income_from_continuing_ops = dm.FloatField(null=True)
...
class YahooHoldersHolders(DatedModel):
    ...
    position_combined_date = dm.DateField(null=True)
...
class YahooHoldersInsiderTransactions(DatedModel):
    ...
    start_date = dm.DateField(null=True)
...
class YahooProfileAssetProfile(DatedModel):
    ...
    address2 = dm.TextField(blank=True)
    ...
    zip = dm.CharField(max_length=12, blank=True)
    phone = dm.CharField(max_length=32, blank=True)
    fax = dm.CharField(max_length=32, blank=True)
...
class YahooNews(DatedModel):
    ...
    ref_earnings = dm.ForeignKey('EarningsCalendar', null=False, on_delete=dm.CASCADE)
    title = dm.TextField(null=False, blank=False)
...
class YahooSustainability(DatedModel):
    ...
    peer_highest_controversy_performance_avg = dm.FloatField(null=True)
    peer_highest_controversy_performance_max = dm.FloatField(null=True)
    peer_highest_controversy_performance_min = dm.FloatField(null=True)
